...
import com.xd.kobepback.mapper.SysResourceMapper;
import com.xd.kobepback.service.SysResourceService;
import com.xd.kobepback.util.TreeUtil;
import com.xd.kobepcommon.constants.CommonConstants;
import com.xd.kobepcommon.enums.DataStatusEnum;
import com.xd.kobepcommon.enums.ResourceTypeEnum;
...
public class SysResourceServiceImpl  extends ServiceImpl<SysResourceMapper, SysResource> implements SysResourceService {
    ...
    public List<String> findPermission(List<String> roles) {
        ...
        for (SysResource menuVo : sysResourcesVoList) {
            if (StringUtils.isNoneEmpty(menuVo.getPermission())) {
