...
/**
 * @description: 需要自定义RedisTokenStore，
 * redis存储token,spring-data-redis 2.0版本中set(String,String)被弃用
 * 要使用LettuceRedisConnection.stringCommands().set(…)
 * @author: pxd
 * @create: 2019-01-22 17:02
 **/
public class LettuceConnectionRedisTokenStore implements TokenStore {
    ...
    public LettuceConnectionRedisTokenStore(RedisConnectionFactory connectionFactory) {
